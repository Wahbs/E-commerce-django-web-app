    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Sexe', models.CharField(choices=[('Masculin', 'Masculin'), ('Feminin', 'Feminin')], max_length=10, verbose_name='Sexe')),
                ('Photo_Profil', models.ImageField(upload_to='', verbose_name='Photo de profil')),
