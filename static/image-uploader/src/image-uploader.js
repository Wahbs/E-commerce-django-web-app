...
(function ($) {
    ...
    $.fn.imageUploader = function (options) {
        ...
        let createContainer = function () {
            ...
            $container = document.querySelector('.image-uploader'),
            ...
            $uploadedContainer = document.querySelector('.uploaded');

                // Create the text container and append it to the container
                /* $textContainer = $('<div>', {
                    class: 'upload-text'
                }).appendTo($container), */
                $textContainer = document.querySelector('.upload-text');
        ...
        let createImg = function (src, id, preloaded) {
            ...
            let $container = document.querySelector('.uploaded-image'),

                // Create the img tag
                $img = document.querySelector('.image-uploader .uploaded .uploaded-image img'),

                // Create the delete button
                $button = document.querySelector('.delete-image'),

                // Create the delete icon
                $i = document.querySelector('.iui-close');
